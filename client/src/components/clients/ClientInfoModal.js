...
import { Button, Modal, Card, Icon, Divider, Header } from 'semantic-ui-react';
              ...
              <div>
                <Card fluid>
                  ...
                  <Card.Content extra>
                    ...
                    <Button size="tiny" onClick={this.onRemove} color="red">
                      Remove
                    </Button>
                  </Card.Content>
                </Card>
...
export default connect(undefined, mapDispatchToProps)(ClientInfoModal);
